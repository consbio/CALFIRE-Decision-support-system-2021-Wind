...
# The txt (csv) files received don't have any spatial information in them. They are just raw text files containing
# data values by row and column representing a subset of the CFO data extent (the row and column range was generated by
